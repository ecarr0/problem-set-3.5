...
public class ProblemSet3_5 {
	...
	public void leapYears(int count) {
		...
		int startLeapYear = 2016;
		if(count == 1) {
			startLeapYear +=4;
			System.out.println("The next leap year is " + (startLeapYear) + ".");
		}
		else if (count == 2) {
			System.out.println("The next " + count + " leap years are " + (startLeapYear + 4) + " and " + (startLeapYear + 8) + ".");
		}
		else {
			startLeapYear +=4;
			System.out.print("The next " + count + " leap years are ");
			for(int i = count; i > 1; i--) {
				if((startLeapYear % 100 == 0) && (startLeapYear % 400 != 0)) {
					startLeapYear += 4;
					i++;
					//DO NOTHING
				}
			...
			System.out.println("and " + (startLeapYear) + ".");
		}
	}
	...
	public void fibonacci(int n) {
		...
		if (n == 1) {
			System.out.println("The 1st Fibonacci number is " + fibNum1 + ".");
		}
		else if(n == 2) {
			System.out.println("The 2nd Fibonacci number is " + fibNum2 + ".");
		}
		else {
			int counter = 0;
			while(counter < n - 1) {
			...
			if (total < 4) {
				System.out.println("The " + n +"rd Fibonacci number is " + fibNum1 + ".");
			}
			else if (total < 21) {
				System.out.println("The " + n + "th Fibonacci number is " + fibNum1 + ".");
			}
			else {
				String ending;
				if(n % 10 == 1) {
				...
				System.out.println("The " + n + ending + " Fibonacci number is " + fibNum1 + ".");
			}
		}
	...
	public void multiples(int x, int y, int limit) {
		...
		System.out.println("The sum of all multiples of " + x + " and " + y + " less than " + limit + " is "
				+ sum +".");
	}
}